...
Home = home.Content(
    ...
    tagline='Linny is an AaaS web-application for executing simple linear-regression models and for evaluating the assumptions of linear-regression across different datasets.',
